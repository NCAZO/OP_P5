...
describe('SessionApiService', () => {
  ...
  it('should display session by Id', () => {
    ...
    sessionService.detail('1').subscribe(session => {
  ...
  it('should delete session by Id', () => {
    ...
    sessionService.delete(sessionId).subscribe();
  ...
  it('should create new session', () => {
    ...
    sessionService.create(newSession).subscribe(session => {
  ...
  it('should update existing session', () => {
    ...
    sessionService.update('1', updatedSession).subscribe(session => {
